...
from .views import (
    ...
    vue_synthese_projet,
    vue_fiche_metier_projet,
    vue_livrables_projet,
    vue_generer_livrables_depuis_parcours,
    vue_livrable_projet_detail,
...
urlpatterns = [
    ...
    path("<uuid:projet_id>/fiche-metier/", vue_fiche_metier_projet, name="projets-fiche-metier"),
    path("<uuid:projet_id>/livrables/", vue_livrables_projet, name="projets-livrables"),
    path("<uuid:projet_id>/livrables/generer-depuis-parcours/", vue_generer_livrables_depuis_parcours, name="projets-livrables-generer"),
    path("<uuid:projet_id>/livrables/<uuid:livrable_id>/", vue_livrable_projet_detail, name="projets-livrable-detail"),
